...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('bonLiv.add.comment') }}" method="post" class="commentForm"
                  id="commentForm0" style="display: none">
                @csrf
                <label>Nouveau commentaire</label>
                <input type="hidden" name="idbonlivraison" value="{{ $data[0]->bonlivraison_id }}">
...
btn-light btn-sm float-right mt-1 ml-1 btn-sm" title="Annuler"><i
