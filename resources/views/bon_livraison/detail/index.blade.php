        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>DETAILS BON DE LIVRAISON "{{ $data[0]->reference_bl }}"</h4>
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ $data[0]->reference_bl }}</a></li>
                </ol>
            </div>
        </div>
...
{{--                                    @endif--}}
{{--                                @endif--}}
                                <a href="{{ route('bon.print',['id' =>$data[0]->bonlivraison_id]) }}" target="_blank" class="btn btn-light btn-sm ml-1"
                                   title="Imprimer ce bon de commande"><i
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="detail" role="tabpanel">
                                    <div class="pt-4">
                                        @include('bon_livraison.detail.detail')
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="message">
                                    <div class="pt-4">
                                        @include('bon_livraison.detail.comment')
                                    </div>
                                </div>
                            </div>
                        </div>
