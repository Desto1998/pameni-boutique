...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('avoir.add.comment') }}" method="post" class="commentForm"
                  id="commentForm0" style="display: none">
                @csrf
                <label>Nouveau commentaire</label>
                <input type="hidden" name="idavoir" value="{{ $data[0]->avoir_id }}">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                <form action="{{ route('comment.update') }}" method="post" class="commentForm"
                    ...
                    <input type="hidden" name="idreservation" value="{{ $data[0]->avoir_id }}">
