                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12 bg-light pt-4">
                        @foreach($categories as $cat)
                            <ul class="cat-ul">
                                <li class="cat-list link-danger"><a class="link-warning cat-link h5" href="{{ route('site.categories',['id'=>$cat->idcat]) }}">{{ $cat->titre }}</a></li>
                            </ul>
                        @endforeach
                    ...
                    <div class="col-md-9 col-sm-12">
                                    ...
                                    <div class="col justify-content-center text-center">
                                        <div class="card shadow-sm p-4">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row my-4 text-center justify-content-center">
                                                        @foreach($images as $img)
                                                            <img class="product-img-min" style="width: 100px" title="" src="<?= $img->chemin ?>" alt="Image introuvable">

                                                        @endforeach
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="alert my-3 alert-light alert-dismissible fade show">
                                                        <h4 class=" my-2 mx-3 text-center titre-color-1 nav-link titre-hover"><?= $produit->nom ?></h4>
                                                        <strong>Categorie: {{ $categorie[0]->titre }}</strong>
                                                    </div>
                                                    <h6>
                                                ...
                                                <hr>
                                                <div class="card-body">
                                                    <label  class="h4 text-warning">Description</label>
                        ...
                        @endforeach
                            <div class="card shadow-sm p-4 mt-4">
                                <div class="row">
                                    <label class="h4">Produits similaires</label>
                                    <div class="row row-cols-0 row-cols-sm-3 row-cols-md-2 g-3">
                                        ...
                                        @if ($produit->idcat===$cat->idcat)
                                            <div class="col justify-content-center text-center">
                                                <div class="card shadow-sm p-4">
                                                    <a  href="{{ route('site.detail',['id'=>$produit->id]) }}" class="detail-link" title="Voir les details" >
                                                        <h4 class="text-yello my-2 mx-3 text-center"><?= $produit->nom ?></h4>
                                                    </a>
                                                    <a href="{{ route('site.detail',['id'=>$produit->id]) }}" class="detail-link">
                                                        <img class="product-img" title="Voir les details" src="<?= $produit->image ?>" alt="Image introuvable">
                                                    </a>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="btn-group">
                                                                ...
                                                                <!--                                            <input type="hidden" name="" value="">-->
                                                                <a href="{{ route('site.add.tocard',['id'=>$produit->id]) }}">
                                                                    <button type="button" class="btn btn-warning my-3" name="add_to_cart">
                                                                        Ajouter au panier <i class="fas fa-shopping-cart"></i></button>
                                                                </a>
