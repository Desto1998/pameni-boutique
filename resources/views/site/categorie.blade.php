                    ...
                    <div class="col-md-9 col-sm-12">
                        @foreach($categorie as $cat)
                            <div class="alert my-3 alert-secondary alert-dismissible fade show">
                                ...
                                <strong>
                                    <label class="cat-titre"><a class="cat-link link-dark h5" href="{{ route('categories.index',['id'=>$cat->idcat]) }}">{{ $cat->titre }}</a></label>
                                </strong><br>
                                <strong>
                                    {{ $cat->description_cat }}
                                </strong>
                                ...
                                @if ($produit->idcat===$cat->idcat)
                                    <div class="col justify-content-center text-center">
                                        <div class="card shadow-sm p-4">
                                            <a  href="{{ route('site.detail',['id'=>$produit->id]) }}" class="titre-color-1 titre-hover" title="Voir les details" >
